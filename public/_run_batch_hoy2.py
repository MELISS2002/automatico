...
L.ARTICULOS = [
    ("Temperaturas en Lima: Senamhi pronostica el inicio de la primavera 2026 y que distritos sentiran mas calor", "home", "temperaturas-lima-senamhi-primavera-2026"),
    ("Aumento del sueldo minimo en Peru 2026: el MEF confirma el monto y las fechas de los incrementos", "salud", "aumento-sueldo-minimo-peru-2026-mef"),
